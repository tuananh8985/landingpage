...
return array(
    'Admin' => $baseDir . '/workbench/ecnet/admin/src/controllers/Admin.php',
    'Analytics' => $baseDir . '/workbench/ecnet/admin/src/controllers/Analytics.php',
    ...
    'ContactsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/ContactsController.php',
    'Content' => $baseDir . '/workbench/ecnet/admin/src/models/Content.php',
    'ContentsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/ContentsController.php',
    ...
    'Cunit' => $baseDir . '/workbench/ecnet/admin/src/models/Cunit.php',
    'DatabaseSeeder' => $baseDir . '/app/database/seeds/DatabaseSeeder.php',
    'DetailCart' => $baseDir . '/workbench/ecnet/admin/src/models/DetailCart.php',
    'EConfig' => $baseDir . '/workbench/ecnet/admin/src/models/EConfig.php',
    'EmailController' => $baseDir . '/workbench/ecnet/admin/src/controllers/EmailController.php',
    ...
    'Group' => $baseDir . '/workbench/ecnet/admin/src/models/Group.php',
    'GroupsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/GroupsController.php',
    ...
    'Image' => $baseDir . '/workbench/ecnet/admin/src/models/Image.php',
    'ImagePage' => $baseDir . '/workbench/ecnet/admin/src/models/ImagePage.php',
    'ImagesController' => $baseDir . '/workbench/ecnet/admin/src/controllers/ImagesController.php',
    ...
    'LoginController' => $baseDir . '/workbench/ecnet/admin/src/controllers/LoginController.php',
    'Math_BigInteger' => $vendorDir . '/phpseclib/phpseclib/phpseclib/Math/BigInteger.php',
    'Media' => $baseDir . '/workbench/ecnet/admin/src/models/Media.php',
    'Mediacat' => $baseDir . '/workbench/ecnet/admin/src/models/Mediacat.php',
    'MediacatsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/MediacatsController.php',
    'Member' => $baseDir . '/app/models/Member.php',
    'MembersController' => $baseDir . '/app/controllers/MembersController.php',
    'Menu' => $baseDir . '/workbench/ecnet/admin/src/models/Menu.php',
    'MenusController' => $baseDir . '/workbench/ecnet/admin/src/controllers/MenusController.php',
    'Menuspack' => $baseDir . '/workbench/ecnet/admin/src/models/Menuspack.php',
    'MenuspacksController' => $baseDir . '/workbench/ecnet/admin/src/controllers/MenuspacksController.php',
    ...
    'MyCurl' => $baseDir . '/app/models/MyCurl.php',
    ...
    'Page' => $baseDir . '/workbench/ecnet/admin/src/models/Page.php',
    'Pagecat' => $baseDir . '/workbench/ecnet/admin/src/models/Pagecat.php',
    'PagecatsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/PagecatsController.php',
    'Pages' => $baseDir . '/workbench/ecnet/admin/src/controllers/Pages.php',
    'PagesController' => $baseDir . '/workbench/ecnet/admin/src/controllers/PagesController.php',
    'Partner' => $baseDir . '/workbench/ecnet/admin/src/models/Partner.php',
    ...
    'Post' => $baseDir . '/workbench/ecnet/admin/src/models/Post.php',
    'PostImage' => $baseDir . '/workbench/ecnet/admin/src/models/PostImage.php',
    'Postcatalog' => $baseDir . '/workbench/ecnet/admin/src/models/Postcatalog.php',
    'PostcatalogsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/PostCatalogsController.php',
    'PostsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/PostsController.php',
    ...
    'Product' => $baseDir . '/workbench/ecnet/admin/src/models/Product.php',
    'Productcat' => $baseDir . '/workbench/ecnet/admin/src/models/Productcat.php',
    'ProductcatsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/Productcats.php',
    'ProductsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/ProductsController.php',
    'Property' => $baseDir . '/workbench/ecnet/admin/src/models/Property.php',
    'PropertyTemplate' => $baseDir . '/workbench/ecnet/admin/src/models/PropertyTemplate.php',
    'PropertyTemplatesController' => $baseDir . '/workbench/ecnet/admin/src/controllers/PropertyTemplatesController.php',
    ...
    'RSlidersElementsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/RSlidersElementsController.php',
    'Role' => $baseDir . '/workbench/ecnet/admin/src/models/Role.php',
    'RolesController' => $baseDir . '/workbench/ecnet/admin/src/controllers/RolesController.php',
    'RslidersController' => $baseDir . '/workbench/ecnet/admin/src/controllers/RslidersController.php',
    'Rss' => $baseDir . '/workbench/ecnet/admin/src/models/Rss.php',
    'RssController' => $baseDir . '/workbench/ecnet/admin/src/controllers/RssController.php',
    'Samkitano\\SeoGen\\Facades\\Robots' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Facades/Robots.php',
    'Samkitano\\SeoGen\\Facades\\Sitemap' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Facades/Sitemap.php',
    'Samkitano\\SeoGen\\Generator' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Generator.php',
    'Samkitano\\SeoGen\\Interfaces\\HelpersInterface' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Interfaces/HelpersInterface.php',
    'Samkitano\\SeoGen\\Interfaces\\RobotsInterface' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Interfaces/RobotsInterface.php',
    'Samkitano\\SeoGen\\Interfaces\\SitemapInterface' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Interfaces/SitemapInterface.php',
    'Samkitano\\SeoGen\\Robots' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Robots.php',
    'Samkitano\\SeoGen\\SeoGenServiceProvider' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/SeoGenServiceProvider.php',
    'Samkitano\\SeoGen\\Sitemap' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Sitemap.php',
    'Samkitano\\SeoGen\\Support\\CustomObject' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Support/CustomObject.php',
    'Samkitano\\SeoGen\\Support\\Helpers' => $vendorDir . '/samkitano/seo-gen/src/Samkitano/SeoGen/Support/Helpers.php',
    'SearchController' => $baseDir . '/workbench/ecnet/admin/src/controllers/SearchController.php',
    'SessionHandlerInterface' => $vendorDir . '/symfony/http-foundation/Resources/stubs/SessionHandlerInterface.php',
    'ShopCart' => $baseDir . '/workbench/ecnet/admin/src/models/ShopCart.php',
    'ShopCartController' => $baseDir . '/workbench/ecnet/admin/src/controllers/ShopCartController.php',
    'Slider' => $baseDir . '/workbench/ecnet/admin/src/models/Slider.php',
    'SlidersController' => $baseDir . '/workbench/ecnet/admin/src/controllers/SlidersController.php',
    'Sliderspack' => $baseDir . '/workbench/ecnet/admin/src/models/Sliderspack.php',
    'SliderspacksController' => $baseDir . '/workbench/ecnet/admin/src/controllers/SliderspacksController.php',
    ...
    'Tag' => $baseDir . '/workbench/ecnet/admin/src/models/tag.php',
    'TagsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/TagsController.php',
    'Template' => $baseDir . '/workbench/ecnet/admin/src/models/Template.php',
    'TemplateLayout' => $baseDir . '/workbench/ecnet/admin/src/models/TemplateLayout.php',
    'TemplatesController' => $baseDir . '/workbench/ecnet/admin/src/controllers/TemplatesController.php',
    'TestCase' => $baseDir . '/app/tests/TestCase.php',
    'UpdateUsersTable' => $baseDir . '/app/database/migrations/2017_09_14_061906_update_users_table.php',
    'UpdateUsersTableAfter' => $baseDir . '/app/database/migrations/2017_09_14_090558_update_users_table_after.php',
    'User' => $baseDir . '/app/models/User.php',
    'UsersController' => $baseDir . '/workbench/ecnet/admin/src/controllers/UsersController.php',
    'Viewnote' => $baseDir . '/workbench/ecnet/admin/src/models/viewnote.php',
    ...
    'abc' => $baseDir . '/app/controllers/abc.php',
    'admin\\AdminController' => $baseDir . '/workbench/ecnet/admin/src/controllers/AdminController.php',
    'admin\\ConfigsController' => $baseDir . '/workbench/ecnet/admin/src/controllers/ConfigsController.php',
);
