...
class UploadHandler
{
    ...
    function __construct($cat,$options = null, $initialize = true) {
        $this->cat = $cat;
        $this->options = array(
            'script_url' => URL::to('admin/mediacats/upload'),
            'upload_dir' => public_path().'/images/medias/'.$cat->folder.'/',
            'upload_url' => URL::to('/images/medias/'.$cat->folder).'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function set_file_delete_properties($file) {
        $file->delete_url = $this->options['script_url']
            .$this->get_query_separator($this->options['script_url'])
            .'file='.rawurlencode($file->name).'&cat='.$this->cat->id;
