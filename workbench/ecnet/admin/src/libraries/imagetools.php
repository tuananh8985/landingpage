<?php
	 ...
	 * <ul>
	 *  <li>Blur Image</li>
	 *  <li>Add two types of watermarking image, text and image</li>
	 *  <li>Crop image</li>
	 *  <li>Grayscale image</li>
	 *  <li>Reflect shadow of the image</li>
	 *  <li>5 types for resizing an image</li>
	 *  <li>Rotating images</li>
	 *  <li>Brightning image</li>
	 *  <li>Contrasting image</li>
	 * </ul>
	 *
	 * WARNING:
	 * This file is exclusively solded by Envato Marketplace and you are not allowed to share this file or publish it on other sites in anyway because its protected from Author Copyrights
	 * Just for personal and commercial use (as PHP programmer)
	 *
	 * Thanks for respecting me as author of this script
	 * Arlind Nushi
	 */
	...
	class ImageTools implements ImageToolsInterface
	{
		...
		private $watermark_font_path = '../src/fonts/ARIAL_0.TTF'; // MAKE THIS PATH ABSOLUTE PATH
		...
		public function resizeOriginal($new_width, $new_height)
		{
			...
			else
			{
				...
				imagecopyresized($this->tmp_im, $this->im, 0, 0, 0, 0, $new_width, $new_height, $this->getX(), $this->getY());
		...
		{
			if( !is_numeric($x) || !is_numeric($y)  || !is_numeric($width)  || !is_numeric($height) || ($width * $height) <= 0 )
			{
