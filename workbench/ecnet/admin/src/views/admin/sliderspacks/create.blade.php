...
<div class="row-fluid">
    <div class="span12">
        <h3 class="page-title">Create Sliderspack</h3>
        <ul class="breadcrumb">
	...
	<div class="span12">
		<div class="portlet box green">
            ...
            <div class="portlet-body">
                ...
                {{ Form::open(array('route' => 'admin.sliderspacks.store')) }}
                <div class="row-fluid">
                    <div class="span12">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="control-group">
                            ...
                            {{ Form::label('image_width', 'Image_width:') }}</div>
                            <div class="controls">{{ Form::input('number', 'image_width','',array('required' => 'required')) }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="control-group">
                            ...
                            <div class="controls">{{ Form::input('number', 'image_height','',array('required' => 'required')) }}</div>
                        </div>
                    </div>
                </div>
