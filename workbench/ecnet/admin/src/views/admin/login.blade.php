...
<head>
  <meta charset="utf-8" />
  <title>{{Config::get('admin::website.title')}}</title>
  <meta content="width=device-width, initial-scale=1.0" name="viewport" />
  <meta content="{{Config::get('admin::website.description')}}" name="description" />
...
<body class="login">
  <!-- BEGIN LOGO -->
  <div class="logo">
    <img src="{{URL::to('/')}}/packages/ecnet/admin/assets/img/logo-big.png" style="margin-top: -50px;height: 150px" alt="" /> 
  </div>
  <!-- END LOGO -->
  <!-- BEGIN LOGIN -->
  <div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="form-vertical login-form" method="POST" action="{{URL::to('admin/login')}}">
      <h3 class="form-title">Tài khoản quản trị</h3>
      ...
      <div class="form-actions" style="margin-left: 10px">
        ...
        <input class="btn green" style="margin-left: 20px;" type="submit"  value="Đăng nhập">
...
<!--     <form class="form-vertical register-form" action="index.html">
  ...
  <script src="{{URL::to('/')}}/packages/ecnet/admin/assets/uniform/jquery.uniform.min.js"></script> 
