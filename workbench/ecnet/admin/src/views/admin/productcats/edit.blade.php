...
<div class="row-fluid">
    <div class="span12">
        <h3 class="page-title">Edit Productcat</h3>
        <ul class="breadcrumb">
...
{{ Form::model($productcat, array('method' => 'PATCH', 'route' => array('admin.productcats.update', $productcat->id))) }}
            <div class="row-fluid">
                <div class="span12">
...
<div class="row-fluid">
        <div class="controls">
            ...
            {{ link_to_route('admin.productcats.show', 'Cancel', $productcat->id, array('class' => 'btn')) }}
        </div>
</div>
{{ Form::close() }}
