...
(function (jQuery){
  jQuery.fn.plusGallery = function(options){
    ...
    var pg = {
      ...
      imagePath: imgpluspath+'images/plusgallery',
      type: null,
      ...
      init: function(){
        ...
        _doc.off("click", ".pgalbumlink, #pgthumbhome, .pgthumbimg, .plus-pagination, .pgzoomarrow, .pgzoomclose, #pgzoomview, #pgzoomslide, .pgzoomimg");
      ...
      parseData: function(json,title,pg_type,obj_click,data_limit){
        ...
        //limit the results
          if(data_limit){
              if(data_limit < pg.imgTotal && data_limit !=0){
